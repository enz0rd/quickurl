...
function EditPageContent() {
  ...
  const onError = (errors: any) => {
    if (errors.name) {
      toast.error(errors.name.message || "Please check the name entered", {
        duration: 3000,
        position: "bottom-center",
        icon: "🚫",
        style: { backgroundColor: "#790000", color: "#fff" },
      ...
      toast.error(
        errors.description.message || "Please check the description entered",
        {
          duration: 3000,
          position: "bottom-center",
          icon: "🚫",
      ...
      toast.error(
        errors.shortName.message || "Please check the short name entered",
        {
          duration: 3000,
          position: "bottom-center",
          icon: "🚫",
  ...
  const handleRemoveLinkFromGroup = async (linkId: string) => {
    try {
      const res = await fetch(
        `/api/groups/remove-link?id=${searchParams.get("id")}&linkId=${linkId}`,
        {
          method: "PATCH",
          headers: {
            "Content-type": "application/json",
      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <div className="flex flex-col gap-2 items-center">
          <motion.h1 
            ...
            className="text-4xl font-bold text-center">edit group</motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {isFetching ? (
            ...
            <motion.div 
              ...
              <span className="font-bold text-zinc-300 text-xl">
                couldn't load group
              </span>
              ...
              <span
                ...
                className="flex flex-row items-center gap-2 cursor-pointer text-zinc-300 text-md mt-2"
              >
            ...
            <Form {...methods}>
              ...
              >
                ...
                <div className="flex flex-row justify-between items-center mt-2">
                  <span
                    onClick={() => (window.location.href = "/dashboard")}
                    className="cursor-pointer text-md text-zinc-400"
                  >
                    back
                  </span>
                  <Button
          ...
          <motion.div
            ...
            className="flex flex-row items-center gap-2 self-start w-full"
          >
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="bg-zinc-950">
                          ...
                          <DropdownMenuItem
                            ...
                            className="focus:bg-zinc-800/60 hover:bg-zinc-800/60"
                          >
                            <span className="text-zinc-300 my-auto">
                              remove from group
                            </span>
                          </DropdownMenuItem>
                        </DropdownMenuContent>
