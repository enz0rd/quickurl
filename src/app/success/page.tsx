  ...
  const handleSubscriptionValidation = async () => {
    ...
    try {
      ...
      if (!sessionId) {
        ...
        toast.error(
          "Failed to validate subscription. Please try again later.",
          {
            duration: 5000,
      ...
      if (token) {
        const validateSubscription = await fetch(
          "/api/subscription/validate-subscription",
          {
            method: "POST",
            headers: {
        ...
        if (validateSubscription.ok) {
          ...
          console.error(
            ...
            validateSubscription.statusText,
          );
        }
      } else {
        toast.error(
          ...
          <h1 className="text-4xl font-bold text-center">
            {loading ? (
              <div className="flex gap-3 items-center">
                ...
                <span className="my-auto">validating subscription</span>
              </div>
            ) : (
