      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <div className="flex flex-col gap-2 items-center m-auto">
          {isSubmitting ? (
              ...
              >
                {loading ? (
                  <div className="flex gap-3 items-center">
                    <Loader className="w-12 h-12 animate-spin my-auto" />
                    <span className="my-auto">resetting 2FA</span>
                  </div>
                ) : (
            ...
            <motion.form
              onSubmit={handleSubmit(handleEmailConfirm)}
              className="flex flex-col gap-2 justify-center items-center w-[300px]"
            >
              <motion.h1 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <motion.p 
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                className="text-gray-500 text-sm mx-2 text-wrap text-center mt-2">
              ...
              <motion.div 
                ...
                className="flex flex-col gap-2 w-[200px] mx-auto">
                <label
                  htmlFor="password"
            ...
            >
                <Button
                    disabled={loading}
                    type="submit"
                    className="w-[200px] bg-lime-500 text-zinc-900 hover:bg-lime-500/60 cursor-pointer"
                >
                    Confirm
                </Button>
              </motion.div>
