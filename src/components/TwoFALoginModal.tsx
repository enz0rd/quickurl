...
export default function TwoFALoginModal({
  userEmail,
  open,
}: {
  userEmail: string;
  ...
  return (
    <AlertDialog open={open}>
      <AlertDialogContent className="z-[999] bg-transparent border-none w-[400px] flex flex-col gap-4 justify-center">
        <BorderGlow
          edgeSensitivity={30}
          glowColor="174 190 0"
          borderRadius={16}
        ...
        >
            ...
            <div className="flex flex-col gap-2">
                <AlertDialogTitle className="flex flex-row gap-2 items-center font-bold">
                <Lock className="h-5 w-5" /> 2FA
                </AlertDialogTitle>
            ...
            <Button
                className="bg-none border-none cursor-pointer text-zinc-400 text-xs mt-2 flex flex-row gap-2 items-center"
