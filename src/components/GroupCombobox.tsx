...
interface GroupComboboxProps {
  onSelectValue?: (
    value: { id: string; name: string; shortName: string } | string,
  ) => void;
  ...
  return (
    isLoggedIn && (
      <Popover open={open} onOpenChange={setOpen}>
        ...
        >
          <PopoverTrigger asChild>
            <Button
              ...
              className="flex flex-row border-none gap-2 items-center cursor-pointer hover:bg-transparent hover:text-zinc-200 text-zinc-300 justify-between bg-transparent rounded-lg"
            >
              {selectedValue ? (
        ...
        <PopoverContent className="bg-transparent rounded-lg border-none">
          <BorderGlow
            edgeSensitivity={10}
            glowColor="174 190 0"
            borderRadius={16}
            ...
            className="p-2"
          >
            <Command className="m-0 bg-transparent text-zinc-200">
              <CommandInput
