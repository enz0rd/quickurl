                ...
                <AlertDialogContent className='bg-zinc-900'>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            You are about to delete group <span className='text-lime-500'>{name}</span>.
                    ...
                    <AlertDialogFooter className='flex md:flex-row flex-col w-full'>
                        ...
                        <Button onClick={() => deleteGroup(id)} disabled={loading} className='bg-red-500/60 hover:bg-red-500/60 cursor-pointer'>
